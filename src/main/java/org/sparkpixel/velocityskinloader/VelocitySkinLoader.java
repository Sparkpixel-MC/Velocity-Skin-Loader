package org.sparkpixel.velocityskinloader;
...
import org.sparkpixel.velocityskinloader.listener.SkinApply;
...
public class VelocitySkinLoader {
    ...
    public void onProxyInitialization(ProxyInitializeEvent event) throws IOException {
        ...
        OfficalAccountCheckUtil.init(this.logger, this.proxyServer);
    }
